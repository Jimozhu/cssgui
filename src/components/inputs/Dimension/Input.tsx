...
interface DimensionInputProps extends EditorPropsWithLabel<Dimension> {
  range?: Range;
  steps?: UnitSteps;
  units?: readonly string[];
  conversions?: UnitConversions;

  // add new props for EZ
  overrideUnits?: (vals: readonly string[]) => string[];
}
